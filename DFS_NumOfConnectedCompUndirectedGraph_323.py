...
class Solution:
    def count_components(self, n, edges):
        ...
        def dfs(source):
            ...
            # here since the adj_list is already created we iterate over every element present in the list
            # This in turn will mean that we visit every neighbour of that element, imp to remember that we have convinient indices
            for neighbour in adj_list[source]:
                # call dfs only of the neighbor hasnt been previously visited
